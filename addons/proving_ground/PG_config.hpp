	...
	class balca_btn_control_group : balca_debug_control_group {
		...
		//column 1
			class balca_cVeh_btn : balca_debug_btn
			{
				...
				y = 0;
				text = "Create vehicle";
				action = "closeDialog 0; createDialog ""balca_debug_veh_creator""; [0] call c_proving_ground_fnc_create_vehicle; if (!isServer) then { ['You may get kicked if BattlEye is monitoring createVehicle.','Warning'] spawn BIS_fnc_guiMessage }";
			};
		...
		//column 2
			...
			class balca_console_btn : balca_debug_btn
			{
				...
				y = btn_height*8;
				text = "Console";
				action = "closeDialog 0;createDialog ""balca_debug_console"";[0] call c_proving_ground_fnc_exec_console; if (!isServer) then { ['Using this function may get you kicked by BattlEye.','Warning'] spawn BIS_fnc_guiMessage }";
			};
		//column 3
