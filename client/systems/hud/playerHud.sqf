...
while {true} do
{
    ...
    _vitals ctrlSetStructuredText parseText format [
														"%1 <img size='0.8' image='client\icons\1.paa'/><br/>" +
														// "%2 <img size='0.8' image='client\icons\water.paa'/><br/>" +
														// "%3 <img size='0.8' image='client\icons\food.paa'/><br/>" +
														"%2 <img size='0.8' image='client\icons\money.paa'/>",
														_health, 
														// thirstLevel,
														// hungerLevel, 
														(player getVariable "cmoney")
													];
